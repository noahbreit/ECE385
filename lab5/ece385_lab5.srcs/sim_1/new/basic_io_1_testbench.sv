module basic_io_1_testbench(); //even though the testbench doesn't create any hardware, it still needs to be a module
...
initial begin: TEST_VECTORS
    ...
    run_i = 0;
    continue_i = 0;
    sw_i = 16'h0003;       // BASIC_IO_1 INPUT IS PC <= 0x0003
    ...
    repeat (4) @(posedge clk)  // BEGIN BASIC_IO_TEST_1 
