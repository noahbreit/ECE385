...
//This driver code is from: https://github.com/Digilent/vivado-library/tree/master/ip/Pmods/pmodOLEDrgb_v1_0/drivers
//The vendor where we sourced the OLED displays
